  ...
  return (
    <div className={styles.page}>
      <div className={styles.welcome_box}>
        <Image
          src={Community}
          className={styles.big_pic}
          priority={true}
          as="image"
          alt="members"
        ></Image>
        <p className={styles.welcome_text}>
          a space for all things mathematics🤍
        </p>
      </div>
      <div className={styles.yellow_box}>
        <div className={styles.textbox}>
          ...
          <p className={styles.description}>
            from peers, professors and professionals.
          </p>
        </div>
        <div className={styles.image_box}>
          <Image
            src={Learn1}
            className={styles.first_pic}
            alt="meeting"
          ></Image>
          <Image
            src={Learn2}
            className={styles.second_pic}
            alt="lecture"
          ></Image>
        </div>
      </div>
      <div className={styles.white_box}>
        <div className={styles.textbox}>
          ...
          <p className={styles.description}>
            through technical workshops and networking events.
          </p>
        </div>
        <div className={styles.image_box}>
          <Image
      ...
      <div className={styles.math_box}>
        <div className={styles.textbox}>
          ...
          <p className={styles.description}>
            open to all backgrounds and majors.
          </p>
        </div>
